...
function onYouTubeIframeAPIReady(){jQuery("body").trigger("hc_yt_api_loaded")}function hc_init_captcha(){if(captcha_script_inserted)return void hc_activate_captcha();captcha_script_inserted=!0;var a=document.createElement("script");a.type="text/javascript",a.src="https://www.google.com/recaptcha/api.js?onload=hc_activate_captcha&render=explicit",document.getElementsByTagName("head")[0].appendChild(a)}function hc_directory_maps(){function a(){p=!0,m&&m.close(),m=!1,i.each(l,function(a,b){google.maps.event.clearInstanceListeners(b),b.setMap(null)}),l=[],j.results.html("")}function b(){k=!0,j.results.html(hc_strings.loading),j.form.find('input[type="search"]').prop("readonly",!0),j.form.find('button[type="submit"], select').prop("disabled",!0)}function c(){k=!1,j.results.find(".il-loading").remove(),j.form.find('input[type="search"]').prop("readonly",!1),j.form.find('button[type="submit"], select').prop("disabled",!1)}function d(a,b,c,d){p=!0;var e=new google.maps.InfoWindow({content:b,maxWidth:150}),f=new google.maps.Marker({position:new google.maps.LatLng(c,d),map:h,title:a,animation:google.maps.Animation.DROP,icon:{path:"M10,0C4.478,0,0,4.479,0,10c0,5.523,10,19.714,10,19.714S20,15.523,20,10C20,4.479,15.521,0,10,0z M10.001,15.714c-3.157,0-5.716-2.561-5.716-5.714c0-3.155,2.559-5.715,5.716-5.715c3.156,0,5.714,2.56,5.714,5.715 C15.715,13.156,13.157,15.714,10.001,15.714z",fillColor:"#F79534",fillOpacity:1,strokeWeight:0}});
// Add marker listener to open info window
return google.maps.event.addListener(f,"click",function(){m&&m.close(),m=e,e.open(h,f)}),f}function e(e,f){a(),b(),e.action="hc_get_listings",e.text=j.form.find('input[type="search"]').val(),e.category_id=j.form.find('select[name="category"] option:selected').val(),i.ajax({url:ajax_object.ajaxurl,type:"POST",data:e,success:function(a){var b=new google.maps.LatLngBounds;switch(a=JSON.parse(a),a.status){case"error":case"info":j.results.html('<div class="alert alert-'+a.status+'">'+a.message+"</div>");break;case"success":j.results.append("<h2>"+a.heading+"</h2>"),p=!0,
// Add each marker
i.each(a.items,function(a,c){o&&c.lat&&c.lng&&(
// Add to map
...
// Add to results list
j.results.append(c.result_html)}),
// Set new center, based on results
o&&f&&(h.setCenter(b.getCenter()),h.fitBounds(b))}c()}})}function f(a){a.preventDefault();var b={};b.type="form",b.location_id=j.form.find('select[name="location"] option:selected').val(),e(b,!0)}function g(){var a={},b=h.getBounds(),c=b.getNorthEast(),d=b.getSouthWest(),f=new google.maps.LatLng(c.lat(),d.lng()),g=new google.maps.LatLng(d.lat(),c.lng());a.type="map",a.ne=[c.lat(),c.lng()],a.nw=[f.lat(),f.lng()],a.se=[g.lat(),g.lng()],a.sw=[d.lat(),d.lng()],e(a,!1)}var h,i=jQuery,j={form:i(".directory-search-form"),results:i(".directory-search-results"),map:i(".directory-map")},k=!1,l=[],m=!1,n={zoom:4,zoomControl:!0,disableDefaultUI:!0,scrollwheel:!1,center:new google.maps.LatLng(hc_directory_coords.lat,hc_directory_coords.lng)},o=!im.lessThan("portrait"),p=!0;
// Update on search
j.form.on("submit",f),
// Activate map + update on drag
o&&(h=new google.maps.Map(j.map[0],n),google.maps.event.addListener(h,"idle",function(){p||g(),p=!1}))}function hc_maybe_load_facebook(){if(!fb_init){fb_init=!0;var a=document.createElement("script");a.type="text/javascript",a.src="https://connect.facebook.net/en_US/sdk.js",document.getElementsByTagName("head")[0].appendChild(a)}}!function(a,b){
...
// HTML Popup
a(".open-popup-link").magnificPopup({type:"inline",midClick:!0,callbacks:{change:function(){var b=a(this.contentContainer).find("input:visible"),c=this.items[this.index].el.data("redirect");b.length>0&&setTimeout(function(){b.eq(0).focus()},50),c&&a(this.contentContainer).find("form").data("redirect",c),a(this.contentContainer).find(".btn-facebook").length>0&&hc_maybe_load_facebook(),a(this.contentContainer).find(".captcha").length>0&&hc_init_captcha(a(this.contentContainer))}}}),
// Entry header slideshow
a(".entry-slideshow").slick({prevArrow:hc_strings.prev_arrow,nextArrow:hc_strings.next_arrow,centerMode:!0,slidesToShow:1,speed:500,variableWidth:!0,responsive:[{breakpoint:im.getValue("phone",!0),settings:{variableWidth:!1}}]}),
...
// Footer IG images
var b=im.lessThan("portrait");a(".async-load-image").each(function(){var c,d,e=a(this);b&&e.hasClass("skip-image-on-mobile")||(c=e.data(),d=document.createElement("img"),a.each(c,function(a,b){a=a.replace("data-",""),d.setAttribute(a,b)}),e.after(d),e.remove())}),
// Buttons nav
a(".content").on("click",".button-nav > .btn",function(){var b=a(this);b.hasClass("use-modal")?a.magnificPopup.open({items:{src:b.data("modal-html")},type:"inline",showCloseBtn:!1}):b.closest(".button-nav").toggleClass("open")})}(window.jQuery);