...
// HTML Popup
a(".open-popup-link").magnificPopup({type:"inline",midClick:!0,callbacks:{open:function(){var b=a(this.contentContainer).find("input:visible");b.length>0&&setTimeout(function(){b.eq(0).focus()},50),a(this.contentContainer).find(".btn-facebook").length>0&&hc_maybe_load_facebook(),a(this.contentContainer).find(".captcha").length>0&&hc_init_captcha(a(this.contentContainer))}}}),
