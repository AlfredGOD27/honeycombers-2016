...
// Footer IG images
var b=im.lessThan("tablet");a(".async-load-image").each(function(){var c,d,e=a(this);b&&e.hasClass("skip-image-on-mobile")||(c=e.data(),d=document.createElement("img"),a.each(c,function(a,b){a=a.replace("data-",""),d.setAttribute(a,b)}),e.after(d),e.remove())}),
// Buttons nav
