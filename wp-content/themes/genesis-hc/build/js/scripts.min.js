...
// Buttons nav
a(".button-nav > .btn").on("click",function(){var b=a(this);b.hasClass("use-modal")?a.magnificPopup.open({items:{src:b.data("modal-html")},type:"inline",showCloseBtn:!1}):b.closest(".button-nav").toggleClass("open")})}(window.jQuery);