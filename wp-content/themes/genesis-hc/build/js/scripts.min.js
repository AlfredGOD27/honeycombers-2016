...
function onYouTubeIframeAPIReady(){jQuery("body").trigger("hc_yt_api_loaded")}function hc_init_captcha(){if(captcha_init)return void hc_activate_captcha();captcha_init=!0;var a=document.createElement("script");a.type="text/javascript",a.src="https://www.google.com/recaptcha/api.js?onload=hc_activate_captcha&render=explicit",document.getElementsByTagName("head")[0].appendChild(a)}function hc_directory_maps(){function a(){
